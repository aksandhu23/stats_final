...
marina_red_plot <- ggplot(data = marina_red_mean, aes(x = date, y = pm2_5_mar)) + geom_point() + labs(title = "2021 PM 2.5 concentration in Marina", x = "Date", y = "PM2.5")

bower_red_plot <- ggplot(data = bower_red_mean, aes(x = date, y = pm2_5_bow)) + geom_point() + labs(title = "2021 PM 2.5 concentration in Bower", x = "Date", y = "PM2.5")

fsl_red_plot <- ggplot(data = fsl_red_mean, aes(x = date, y = pm2_5_fsl)) + geom_point() + labs(title = "2021 PM 2.5 concentration in FSL", x = "Date", y = "PM2.5")

sausal_red_plot <- ggplot(data = sausal_red_mean, aes(x = date, y = pm2_5_sau)) + geom_point() + labs(title = "2021 PM 2.5 concentration in Sausal", x = "Date", y = "PM2.5")
...
alameda_green_plot <- ggplot(data = alameda_green_mean, aes(x = date, y = pm2_5_ala)) + geom_point() + labs(title = "2021 PM 2.5 concentration in Alameda", x = "Date", y = "PM2.5")

holman_green_plot <- ggplot(data = holman_green_mean, aes(x = date, y = pm2_5_hol)) + geom_point() + labs(title = "2021 PM 2.5 concentration in Holman", x = "Date", y = "PM2.5")

marina_green_plot <- ggplot(data = marina_green_mean, aes(x = date, y = pm2_5_mag)) + geom_point() + labs(title = "2021 PM 2.5 concentration in MarinaG", x = "Date", y = "PM2.5")

piedmont_green_plot <- ggplot(data = piedmont_green_mean, aes(x = date, y = pm2_5_pie)) + geom_point() + labs(title = "2021 PM 2.5 concentration in Piedmont", x = "Date", y = "PM2.5")
...
```{r, warning = FALSE, echo = FALSE, message = FALSE}
# Hypothesis Test
t.test(x = green_zones$pm2_5_ala, y = red_zones$pm2_5_bow)

t.test(x = red_zones$PMean, y = green_zones$PMean)
```
